/*
   UpdateLandingPageTemplateContent.cs
...
namespace Samples
{
    ...
    class UpdateLandingPageTemplateContent
    {
        ...
        {
            var content = new UpdateLandingPageTemplateContent();
            content.id = 1001;
            content.content = File.ReadAllText("C:\\LandingPageContent\\template.html");
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/landingPageTemplate/" + id + "/content.json?access_token=" + getToken();
