...
namespace Samples
{
    ...
    class DeleteFolder
    {
        ...
        public int id;//id of folder to delete
        public String type;//type of target folder, must be Folder

        /*
        public static void Main(string[] args)
        {
            var delete = new DeleteFolder();
            delete.id = 99999999;
            delete.type = "Folder";
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/folder/" + id + "/delete.json?access_token=" + getToken() + "&type=" + type;
            Console.Write(url);
