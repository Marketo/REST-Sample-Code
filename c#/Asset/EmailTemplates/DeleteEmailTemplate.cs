...
namespace Samples
{
    ...
    class DeleteEmailTemplate
    {
        ...
        public int id;//id of template to delete, required

        /*
        public static void Main(string[] args)
        {
            var delete = new DeleteEmailTemplate();
            delete.id = 10000;
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/emailTemplate/" + id + "/delete.json?access_token=" + getToken();
