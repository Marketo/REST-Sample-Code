...
namespace Samples
{
    ...
    class ApproveEmailTemplate
    {
        ...
        {
            var template = new ApproveEmailTemplate();
            template.id = 1001;
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/emailTemplate/" + id + "/approveDraft.json?access_token=" + getToken();
