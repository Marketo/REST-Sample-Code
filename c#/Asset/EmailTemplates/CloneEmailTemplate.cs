...
namespace Samples
{
    ...
    class CloneEmailTemplate
    {
        ...
        {
            var template = new CloneEmailTemplate();
            template.id = 1001;
            template.name = "Cloned C# Example Template";
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/emailTemplate/" + id + "/clone.json?";
