/*
   UnapproveEmailTemplateDraft.cs
...
namespace Samples
{
    ...
    class UnapproveEmailTemplate
    {
        ...
        {
            var template = new UnapproveEmailTemplate();
            template.id = 1001;
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/emailTemplate/" + id + "/unapprove.json?access_token=" + getToken();
