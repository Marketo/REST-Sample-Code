...
namespace Samples
{
    ...
    class DiscardEmailTemplateDraft
    {
        ...
        {
            var template = new DiscardEmailTemplateDraft();
            template.id = 1001;
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/emailTemplate/" + id + "/discardDraft.json?access_token=" + getToken();
