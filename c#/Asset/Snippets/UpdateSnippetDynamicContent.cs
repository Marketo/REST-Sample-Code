/*
   UpdateSnippetDynamicContent.cs
...
namespace Samples
{
    ...
    class UpdateSnippetDynamicContent
    {
        ...
        public int id;//id of snippet
        public int segmentId;//id of dynamicContent segment
        public String type;//type of content, HTML or Text, optional
        public String value;//content to submit

        /*
        public static void Main(string[] args)
        {
            var content = new UpdateSnippetDynamicContent();
            content.id = 7;
            content.segmentId = 1007;
            content.type = "HTML";
            content.value = "<div>Here's some Content</div>";
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/snippet/" + id + "/dynamicContent/" + segmentId + ".json?";
            //Serialize the Data
