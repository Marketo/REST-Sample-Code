...
namespace Samples
{
    ...
    class CloneSnippet
    {
        ...
        {
            var snippet = new CloneSnippet();
            snippet.id = 1001;
            snippet.name = "Cloned C# Example Snippet";
            snippet.folder = new Dictionary<string, dynamic>();
            snippet.folder.Add("id", 15);
            snippet.folder.Add("type", "Folder");
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/asset/v1/snippet/" + id + "/clone.json?";
