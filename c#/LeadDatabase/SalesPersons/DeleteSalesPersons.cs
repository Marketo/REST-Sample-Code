...
namespace Samples
{
    ...
    class DeleteSalesPersons
    {
        ...
        {
            var delete = new DeleteSalesPersons();
            delete.input = new List<Dictionary<string, dynamic>>();
            var sp1 = new Dictionary<string, dynamic>();
            sp1.Add("externalSalespersonId", "C# Test Person");
            delete.input.Add(sp1);
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/v1/salespersons/delete.json?access_token=" + getToken();
