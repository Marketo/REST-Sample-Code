...
namespace Samples
{
    ...
    class UpsertSalesPersons
    {
        ...
        public List<Dictionary<string, dynamic>> input;//list of SalesPerson representations
        ...
        {
            var upsert = new UpsertSalesPersons();
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/v1/salespersons.json?access_token=" + getToken();
