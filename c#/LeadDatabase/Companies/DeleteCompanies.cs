...
namespace Samples
{
    ...
    class DeleteCompanies
    {
        ...
        {
            var delete = new DeleteCompanies();
            delete.input = new List<Dictionary<string, dynamic>>();
            var company1 = new Dictionary<string, dynamic>();
            company1.Add("externalCompanyId", "C#TextCompany");
            delete.input.Add(company1);
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/v1/companies/delete.json?access_token=" + getToken();
