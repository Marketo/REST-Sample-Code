...
namespace Samples
{
    ...
    class UpsertRoles
    {
        ...
        public List<Dictionary<string, dynamic>> input;//list of Opportunity representations
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/v1/opportunities/roles.json?access_token=" + getToken();
