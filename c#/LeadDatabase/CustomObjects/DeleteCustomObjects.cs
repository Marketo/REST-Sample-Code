...
namespace Samples
{
    ...
    class DeleteCustomObjects
    {
        ...
        {
            var delete = new DeleteCustomObjects();
            delete.name = "pet";
            delete.input = new List<Dictionary<string, dynamic>>();
            var pet1 = new Dictionary<string, dynamic>();
            pet1.Add("owner", "Steve");
            pet1.Add("name", "Fido");
            delete.input.Add(pet1);
        ...
        */
        ...
        {
            //Assemble the URL
            String url = host + "/rest/v1/customobjects/" + name + "/delete.json?access_token=" + getToken();
