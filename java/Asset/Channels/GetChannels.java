...
public class GetChannels{
	...
	public int maxReturn;//max number of records to return, default 20, max 200
	
	public static void main(String[] args){
		GetChannels channels = new GetChannels();
		String result = channels.getData();
	...
	public String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/channels.json?");
        	if (offset > 0){
        		endpoint.append("offset=" + Integer.toString(offset) + "&");
        	}
        	if (maxReturn > 0){
        		endpoint.append("maxReturn=" + Integer.toString(maxReturn));
        	}
