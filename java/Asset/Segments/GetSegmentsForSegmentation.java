/*
   GetSegmentsForSegmentation.java
...
public class GetSegments {
	...
	public int id;//id of segmentation to retrieve from
	public String status;//optional status filter, accepts draft or approved
	
	public static void main(String[] args){
		GetSegments segments = new GetSegments();
		segments.id = 1001;
		String result = segments.getData();
		System.out.println(result);
	}
	private String getData() {
        String data = null;
        try {
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/segmentation/" + id + "/segments.json?access_token=" + getToken());
