...
public class DeleteEmailTemplate {
	...
	public int id;//id of template to delete
	
	public static void main(String[] args){
		DeleteEmailTemplate template = new DeleteEmailTemplate();
		template.id = 1001;
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/"+ id + "/delete.json?access_token=" + getToken());
