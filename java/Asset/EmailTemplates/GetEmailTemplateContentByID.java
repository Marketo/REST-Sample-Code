/*
   GetEmailTemplateContentByID.java
...
public class EmailTemplateContent {
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/"+ id + "/content.json?access_token=" + getToken());
        	if(status != null){
