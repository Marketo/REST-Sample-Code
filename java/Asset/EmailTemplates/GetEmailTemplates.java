...
public class MultipleEmailTemplates {
	...
	public static void main(String[] args){
		MultipleEmailTemplates templates = new MultipleEmailTemplates();
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplates.json?access_token=" + getToken());
