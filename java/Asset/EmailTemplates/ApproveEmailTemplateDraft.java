/*
   ApproveEmailTemplateDraft.java
...
public class ApproveEmailTemplate {
	...
	public static void main(String[] args){
		ApproveEmailTemplate template = new ApproveEmailTemplate();
		template.id = 1001;
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/"+ id + "/approveDraft.json?access_token=" + getToken());
