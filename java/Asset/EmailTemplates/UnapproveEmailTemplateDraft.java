/*
   UnapproveEmailTemplateDraft.java
...
public class UnapproveEmailTemplate {
	...
	public int id; //id of email template to unapprove
	
	public static void main(String[] args){
		UnapproveEmailTemplate template = new UnapproveEmailTemplate();
		template.id = 1001;
	...
	private String postData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/"+ id + "/unapprove.json?access_token=" + getToken());
