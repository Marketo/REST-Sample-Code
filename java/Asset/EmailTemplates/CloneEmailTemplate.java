...
public class CloneEmailTemplate {
	...
	public int id; //id of template to clone from
	public String name; //new name of resulting clone
	public JsonObject folder; //Json Representation of folder with two members, id and type(Folder or Program)
	
	public static void main(String[] args){
		CloneEmailTemplate template = new CloneEmailTemplate();
		template.id = 1001;
		template.name = "clone";
		template.folder = new JsonObject()
								.add("id", 1071)
								.add("type", "Program");
	...
	private String postData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/"+ id + "/clone.json?access_token=" + getToken()
