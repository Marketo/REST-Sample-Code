...
public class EmailTemplateByName {
	...
	public static void main(String[] args){
		EmailTemplateByName template = new EmailTemplateByName();
		template.name = "Blank";
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/byName.json?access_token=" + getToken() + "&name=" + name);
