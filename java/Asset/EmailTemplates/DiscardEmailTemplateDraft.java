/*
   DiscardEmailTemplateDraft.java
...
public class DiscardEmailTemplateDraft {
	...
	public int id; //id of email template to discard draft from
	
	public static void main(String[] args){
		DiscardEmailTemplateDraft template = new DiscardEmailTemplateDraft();
		template.id = 1001;
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/"+ id + "/discardDraft.json?access_token=" + getToken());
