/*
   UpdateEmailTemplateMetadata.java
...
public class UpdateEmailTemplate {
	...
	public static void main(String[] args){
		UpdateEmailTemplate update = new UpdateEmailTemplate();
		update.id = 1001;
		update.name = "NAME";
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/emailTemplate/" + id + ".json?access_token=" + getToken());
