...
public class UpdateSnippet {
	...
	public static void main(String[] args){
		UpdateSnippet update = new UpdateSnippet();
		update.id = 7;
		update.name = "New Snipppet 3";
	...
	public String postData(){
		...
		try {
			...
			String endpoint = marketoInstance + "/rest/asset/v1/snippet/" + id + ".json?access_token=" + getToken();
