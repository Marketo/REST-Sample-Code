...
public class DiscardSnippetDraft {
	...
	public int id;//id of snippet to discard draft from
	
	public static void main(String[] args){
		DiscardSnippetDraft update = new DiscardSnippetDraft();
		update.id = 7;
	...
	public String postData(){
		...
		try {
			//Assemble the URL
			String endpoint = marketoInstance + "/rest/asset/v1/snippet/" + id + "/discardDraft.json?access_token=" + getToken();
