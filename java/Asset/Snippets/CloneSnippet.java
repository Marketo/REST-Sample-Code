...
public class CloneSnippet {
	...
	public int id; //id of snippet to clone from
	public String name; //name of new snippet
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/snippet/"+ id + "/clone.json?access_token=" + getToken()
