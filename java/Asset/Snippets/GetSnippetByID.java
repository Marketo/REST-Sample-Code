...
public class Snippet {
	...
	public String status;//filter on status, draft, approved, or deleted
	...
	private String getData() {
        String data = null;
        try {
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/snippet/" + id + ".json?access_token=" + getToken());
