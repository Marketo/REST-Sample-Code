...
public class SnippetContent {
	...
	public static void main(String[] args){
		SnippetContent snippet = new SnippetContent();
		snippet.id = 7;
	...
	private String getData() {
        String data = null;
        try {
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/snippet/" + id + "/content.json?access_token=" + getToken());
