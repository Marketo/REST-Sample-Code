...
public class MultipleSnippets {
	...
	public Integer offset;//integer offset for paging
	public Integer maxReturn; //maximum number of snippets to return, default 20, max 200
	public String status; //optional status filter on draft, approved, or delete
	
	
	public static void main(String[] args){
		MultipleSnippets snippets = new MultipleSnippets();
		String result = snippets.getData();
		System.out.println(result);
	}
	private String getData() {
        String data = null;
        try {
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/snippets.json?access_token=" + getToken());
        	if (offset != null){
