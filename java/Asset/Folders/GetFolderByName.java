...
public class FolderByName {
	...
	public String name; //name of the folder to retrieve
	public String type; //type of folder to retrieve, Program or Folder
	public String workSpace; //workspace to search, required if subscription has workspaces
	public Integer root; //ID of the root folder
	
	public static void main(String[] args){
		FolderByName folder = new FolderByName();
		folder.name = "Files";
		folder.type = "Folder";
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/folder/byName.json?access_token=" + getToken() + "&type=" + type + "&name=" + name);
        	//Add optional parameters
        	if (workSpace != null){
        		endpoint.append("&workSpace=" + workSpace);
        	}
        	if (root != null){
        		endpoint.append("&root=" + root);
        	}
