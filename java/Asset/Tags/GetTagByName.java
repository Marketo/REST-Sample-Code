...
public class GetTagByName{
	...
	public String name;//name of tag to retrieve
	
	public static void main(String[] args){
		GetTagByName tags = new GetTagByName();
		tags.name = "Presenter";
	...
	public String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/tagType/byName.json?name=" + name);
