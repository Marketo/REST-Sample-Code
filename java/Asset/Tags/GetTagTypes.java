...
public class GetTags{
	...
	public int maxReturn;//number of records to return, default 20, max 200
	
	public static void main(String[] args){
		GetTags tags = new GetTags();
		String result = tags.getData();
	...
	public String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/tagTypes.json?");
        	if (offset > 0){
