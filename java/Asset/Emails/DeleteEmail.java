...
public class DeleteEmail {
	...
	public int id;//id of email to delete
	
	public static void main(String[] args){
		DeleteEmail email = new DeleteEmail();
		email.id = 1001;
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/email/"+ id + "/delete.json?access_token=" + getToken());
