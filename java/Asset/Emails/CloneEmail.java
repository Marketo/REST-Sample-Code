...
public class CloneEmail {
	...
	public int id; //id of email to clone from
	public String name; //name of new email
	public JsonObject folder; //Json of new parent folder with two members, id and type(Folder or Program)
	public String description; //new description
	public Boolean isOperational; //option to set clone as operational
	
	public static void main(String[] args){
		CloneEmail email = new CloneEmail();
		email.id = 1001;
		email.name = "clone";
		email.folder = new JsonObject()
								.add("id", 1071)
								.add("type", "Program");
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/email/"+ id + "/clone.json?access_token=" + getToken()
        	...
        	if (isOperational != null){
        		endpoint.append("&isOperational" + isOperational);
        	}
