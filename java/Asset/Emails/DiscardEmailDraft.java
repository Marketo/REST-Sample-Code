...
public class DiscardEmailDraft {
	...
	public int id; //id of email to discard from
	
	public static void main(String[] args){
		DiscardEmailDraft email = new DiscardEmailDraft();
		email.id = 1001;
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/email/"+ id + "/unapprove.json?access_token=" + getToken());
