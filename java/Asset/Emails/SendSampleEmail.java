...
public class SendSampleEmail {
	...
	public int id; //id of sample email to send
	public String emailAddress; //email address to send to
	public Boolean textOnly; //set to true to send text only version, default false
	public Integer leadId; //id of lead to impersonate in sample email
	
	public static void main(String[] args){
		SendSampleEmail email = new SendSampleEmail();
		email.id = 1001;
	...
	private String postData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/email/"+ id + "/discardDraft.json?access_token=" + getToken());
        	//append optional params
        	if (textOnly == true){
        		endpoint.append("&textOnly=" + "true");
        	}
        	if (leadId != null){
        		endpoint.append("&leadId=" + leadId);
        	}
