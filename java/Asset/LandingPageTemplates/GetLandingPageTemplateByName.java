/*
   GetLandingPageTemplateByName.java
...
public class LandingPageTemplateByName {
	...
	public String name; //name to search by
	public String status; //optional filter on status
	
	public static void main(String[] args){
		LandingPageTemplateByName template = new LandingPageTemplateByName();
		template.name = "Blank";
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/landingPageTemplate/byName.json?access_token=" + getToken() + "&name=" + name);
