...
public class LandingPageTemplateContent {
	...
	public int id; //id of template to get content from
	public String status; //optional status filter
	
	public static void main(String[] args){
		LandingPageTemplateContent template = new LandingPageTemplateContent();
		template.id = 1001;
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/landingPageTemplate/"+ id + "/content.json?access_token=" + getToken());
        	if(status != null){
