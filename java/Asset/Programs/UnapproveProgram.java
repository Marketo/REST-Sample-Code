...
public class UnapproveProgram {
	...
	public int id; //id of the program to approve
	
	
	public static void main(String[] args){
		UnapproveProgram program = new UnapproveProgram();
		program.id = 1098;
	...
	public String postData(){
		String result = null;
		try {
			String endpoint = marketoInstance + "/rest/asset/v1/program/" + id + "/unapprove.json";
