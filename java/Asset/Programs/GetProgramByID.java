...
public class GetProgramById{
	...
	public int id; //ID of the program to retrieve, required
	
	public static void main(String[] args){
		GetProgramById program = new GetProgramById();
		program.id = 1073;
	...
	public String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/program/" + id + ".json");
