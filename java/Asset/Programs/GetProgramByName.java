...
public class GetProgramByName{
	...
	public String name;//name of program to retrieve
	
	public static void main(String[] args){
		GetProgramByName program = new GetProgramByName();
		program.name = "NewScheduleCampaign3";
		String result = program.getData();
	...
	public String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/program/byName.json?name=" + name);
