...
public class FileByName {
	...
	public static void main(String[] args){
		FileByName file = new FileByName();
		file.name = "newFile.txt";
		String result = file.getData();
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/file/byName.json?access_token=" + getToken()
        			+ "&name=" + name);
