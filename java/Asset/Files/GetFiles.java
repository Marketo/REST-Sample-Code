...
public class ListFiles {
	...
	public Integer offset; //offset returned from previous call
	public Integer maxReturn; //max number of files to return
	
	public static void main(String[] args){
		ListFiles files = new ListFiles();
		files.folder = new JsonObject()
							.add("id", 5565)
							.add("type", "Folder");
		String result = files.getData();
