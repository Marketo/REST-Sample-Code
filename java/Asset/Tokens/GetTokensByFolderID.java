...
public class Tokens {
	...
	public int folderId;//id of folder to retrieve from, required
	public String folderType;//type of folder, Program or Folder, required
	
	public static void main(String[] args){
		Tokens tokens = new Tokens();
		tokens.folderId = 1071;
		tokens.folderType = "Program";
		String result = tokens.getData();
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/asset/v1/folder/"+ folderId + "/tokens.json?access_token=" + getToken() + "&folderType=" + folderType);
