...
public class LeadsByList {
    ...
    public static void main(String[] args) {
        LeadsByList leads = new LeadsByList();
        leads.listId = 1234;
    ...
    private String getData() {
        ...
        try {
        	...
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/list/" + listId + "/leads.json?access_token=" + getToken());
