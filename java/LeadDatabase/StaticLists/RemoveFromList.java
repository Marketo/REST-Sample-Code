...
public class RemoveFromList {
	...
	public int[] ids;//one or more lead IDs, required
	public int listId; //id of list, required
	
	public static void main(String[] args){
		RemoveFromList add = new RemoveFromList();
		add.listId = 1;
	...
	public String postData(){
		...
		try {
			//Assemble URL
			String endpoint = marketoInstance + "/rest/v1/lists/" + listId + "/leads.json?access_token=" + getToken() + "&id=" + csvString(ids);
