...
public class MemberOfList {
	...
	public static void main(String[] args){
		MemberOfList add = new MemberOfList();
		add.listId = 1;
	...
	public String postData(){
		String result = null;
		try {
			//Assmble URL for Request
			String endpoint = marketoInstance + "/rest/v1/lists/" + listId + "/leads/ismember.json?access_token=" + getToken() + "&id=" + csvString(ids);
