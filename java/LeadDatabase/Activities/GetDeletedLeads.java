...
public class DeletedLeads {
	...
	public static void main(String[] args){
		DeletedLeads deletes = new DeletedLeads();
		deletes.nextPageToken = "ZX7GSH7IIOPV4SYG7GUREAQZXSFG5F6FHDEIXVRDWFYB6IULXHLA====";
		String result = deletes.getData();
