...
public class LeadChanges {
	...
	public String[] fields;//optional list of fieds to retrieve changes for
	
	public static void main(String[] args){
		LeadChanges changes = new LeadChanges();
		changes.fields = new String[]{"firstName", "lastName", "id", "email"};
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/activities/leadchanges.json?access_token=" + getToken());
