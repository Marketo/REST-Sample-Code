...
public class ImportWarnings {
	...
	public int id; //batch id returned by import lead
	
	
	public static void main(String[] args){
		ImportWarnings status = new ImportWarnings();
		status.id = 1001;
		String result = status.getData();
	...
	private String getData() {
        ...
        try {
        	//Assemble to URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/bulk/v1/leads/batch/" + id + "warnings.json?access_token=" + getToken());
