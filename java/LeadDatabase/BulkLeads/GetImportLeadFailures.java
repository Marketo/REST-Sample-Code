...
public class ImportFailures {
	...
	public static void main(String[] args){
		ImportFailures status = new ImportFailures();
		status.id = 1001;
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/bulk/v1/leads/batch/" + id + "failures.json?access_token=" + getToken());
