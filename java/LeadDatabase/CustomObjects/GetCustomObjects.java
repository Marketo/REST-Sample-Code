...
public class MultipleCustomObjects {
	...
	public String nextPageToken; //paging token from previous call
	...
	public static void main(String[] args) {
		MultipleCustomObjects customs = new MultipleCustomObjects();
		customs.filterType = "Name";
		customs.filterValues = new String[]{"Spot", "Fido"};
		customs.name = "pet";
		String result = customs.getData();
    ...
    private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/customobjects/" + name + ".json?access_token=" + getToken() + "&filterType=" + filterType + "&filterValues=" + csvString(filterValues));
