...
public class DescribeCompany {
	...
	public static void main(String[] args){
		DescribeCompany describe = new DescribeCompany();
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/companies/describe.json?access_token=" + getToken());
