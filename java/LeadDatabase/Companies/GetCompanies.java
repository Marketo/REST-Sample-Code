...
public class MultipleCompanies {
	...
	public static void main(String[] args) {
		MultipleCompanies companies = new MultipleCompanies();
		companies.filterType = "externalcompanyid";
		companies.filterValues = new String[]{"CompanyTest1"};
		String result = companies.getData();
    ...
    private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/companies.json?access_token=" + getToken() + "&filterType=" + filterType + "&filterValues=" + csvString(filterValues));
