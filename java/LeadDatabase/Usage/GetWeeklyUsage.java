...
public class SevenDayUsage {
	...
	public static void main(String[] args){
		SevenDayUsage usage = new SevenDayUsage();
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/stats/usage/last7days.json?access_token=" + getToken());
