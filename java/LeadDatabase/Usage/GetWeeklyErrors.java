...
public class SevenDaysErrors {
	...
	public static void main(String[] args){
		SevenDaysErrors errors = new SevenDaysErrors();
		String result = errors.getData();
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/stats/errors/last7days.json?access_token=" + getToken());
