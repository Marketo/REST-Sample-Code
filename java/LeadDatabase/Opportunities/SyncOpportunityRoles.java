...
public class UpsertOpportunityRoles {
	...
	public JsonObject[] input; //an array of Opportunities to use for input.  Each must have a member "externalopportunityid".
	...
	public static void main(String[] args){
		UpsertOpportunityRoles upsert = new UpsertOpportunityRoles();
		JsonObject role = new JsonObject().add("leadId", 1).add("externalopportunityid", "Opportunity1Test");
		upsert.input = new JsonObject[]{role};
	...
	public String postData(){
		...
		try {
			...
			String endpoint =  marketoInstance + "/rest/v1/opportunities/roles.json?access_token=" + getToken(); //takes the endpoint URL and appends the access_token parameter to authenticate
