...
public class UpsertOpportunities {
	...
	public static void main(String[] args){
		UpsertOpportunities upsert = new UpsertOpportunities();
		JsonObject opp1 = new JsonObject().add("name", "opportunity1").add("externalopportunityid", "Opportunity1Test");
		upsert.input = new JsonObject[]{opp1};
	...
	public String postData(){
		...
		try {
			...
			String endpoint =  marketoInstance + "/rest/v1/opportunities.json?access_token=" + getToken(); //takes the endpoint URL and appends the access_token parameter to authenticate
