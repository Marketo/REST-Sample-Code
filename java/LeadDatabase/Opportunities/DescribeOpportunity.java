...
public class DescribeOpportunity {
	...
	public static void main(String[] args){
		DescribeOpportunity describe = new DescribeOpportunity();
	...
	private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/opportunities/describe.json?access_token=" + getToken());
