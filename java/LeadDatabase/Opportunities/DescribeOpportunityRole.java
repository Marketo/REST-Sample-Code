...
public class DescribeOpportunityRoles {
	...
	public static void main(String[] args){
		DescribeOpportunityRoles describe = new DescribeOpportunityRoles();
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/opportunities/roles/describe.json?access_token=" + getToken());
