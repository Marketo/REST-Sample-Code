...
public class MultipleOpportunities {
	...
	public static void main(String[] args) {
		MultipleOpportunities oppties = new MultipleOpportunities();
		oppties.filterType = "externalopportunityid";
		oppties.filterValues = new String[]{"OpportunityTest1"};
		String result = oppties.getData();
    ...
    private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/opportunities.json?access_token=" + getToken() + "&filterType=" + filterType + "&filterValues=" + csvString(filterValues));
