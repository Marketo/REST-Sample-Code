...
public class DeleteOpportunities {
	//You should only use this example on a sandbox environment
	//It will REALLY delete opportunities permanently
	...
	public static void main(String[] args){
		DeleteOpportunities deleteOpps = new DeleteOpportunities();
		deleteOpps.dedupeBy = "idField";
		deleteOpps.ids = new int[]{10000,20000,30000};
		String result = deleteOpps.postData();
	...
	public String postData(){
		...
		try {
			//Assemble the URL
			String endpoint = marketoInstance + "/rest/v1/opportunities/delete.json?access_token=" + getToken();
