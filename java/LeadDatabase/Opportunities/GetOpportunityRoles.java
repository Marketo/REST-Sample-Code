...
public class MultipleOpportunityRoles {
	...
	public String nextPageToken; //paging token from a previous call
	public String[] fields; //optional list of fields to return
	public String filterType; //field to filter by
	public String[] filterValues; //one or more values to filter on
	
	public static void main(String[] args) {
		MultipleOpportunityRoles roles = new MultipleOpportunityRoles();
		roles.filterType = "externalopportunityid";
		roles.filterValues = new String[]{"OpportunityTest1"};
		String result = roles.getData();
    ...
    private String getData() {
        ...
        try {
        	//assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/opportunities/roles.json?access_token=" + getToken() + "&filterType=" + filterType + "&filterValues=" + csvString(filterValues));
