...
public class AssociateLead {
	...
	public static void main(String[] args) {
		try {
			...
			associate.id = 1;
			associate.cookie = URLEncoder.encode("_mkto_trk=id:299-BYM-827&token:_mch-localhost-1435105067262-67189", "UTF-8");
			String result = associate.getData();
    ...
    private String getData() {
        ...
        try {
        	...
        	String endpoint = marketoInstance + "/rest/v1/leads/" + id + "/associate.json?access_token=" +  getToken() + "&cookie=" + cookie;
