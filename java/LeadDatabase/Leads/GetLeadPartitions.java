...
public class GetLeadPartitions {
	...
	public static void main(String[] args){
		GetLeadPartitions getPartitions = new GetLeadPartitions();
		String result = getPartitions.getData();
	...
	private String getData() {
        ...
        try {
        	...
        	String endpoint = marketoInstance + "/rest/v1/leads/partitions.json?access_token=" + getToken();
