...
public class DeleteLeads {
	...
	//It will REALLY delete leads permanently
	...
	public int[] ids;//one or more lead IDs to delete
	
	public static void main(String[] args){
		//This example should be considered purely demonstrative
		//and should only be used in a sandbox environment
		DeleteLeads deleteLeads = new DeleteLeads();
		deleteLeads.ids = new int[]{10000,20000,30000};
		
		//String result = deleteLeads.deleteData();
	...
	public String deleteData(){
		...
		try {
			...
			String endpoint = marketoInstance + "/rest/v1/leads.json?access_token=" + getToken() + "&id=" + csvString(ids);
