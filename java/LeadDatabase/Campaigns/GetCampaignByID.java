...
public class Campaign {
	...
	public int id;//id of the campaign to retrieve
	
	public static void main(String[] args){
		Campaign campaign = new Campaign();
		campaign.id = 1001;
		String result = campaign.getData();
	...
	private String getData() {
        ...
        try {
        	//Assemble the URL
        	StringBuilder endpoint = new StringBuilder(marketoInstance + "/rest/v1/campaigns/" + id + ".json?access_token=" + getToken());
