...
response = RestClient.post "#{host}/rest/v1/customobjects/#{name}/delete.json?access_token=#{access_token}", JSON.generate(body), {:content_type => "application/json"}
