...
input =[
  {
    :externalCompany => "Ruby Company 1"
  }
]
body = {
  :input => input,
...
response = RestClient.post "#{host}/rest/v1/companies/delete.json?access_token=#{access_token}", JSON.generate(body), {:content_type => "application/json"}
