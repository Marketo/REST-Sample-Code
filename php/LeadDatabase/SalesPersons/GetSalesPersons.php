...
class GetOpportunities{
	...
	public function getData(){
		$url = $this->host . "/rest/v1/salespersons.json?access_token=" . $this->getToken() . "&filterType=" . $this->filterType
