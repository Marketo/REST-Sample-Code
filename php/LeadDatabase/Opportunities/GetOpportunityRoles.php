...
*/
$roles = new GetOpportunityRoles();
$roles->filterType = "externalopportunityid";
$roles->filterValues = ["Opportunity Test 1"];
print_r($roles->getData());


class GetOpportunityRoles{
	...
	public function getData(){
		$url = $this->host . "/rest/v1/opportunities/roles.json?access_token=" . $this->getToken() . "&filterType=" . $this->filterType
